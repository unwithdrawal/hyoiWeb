...
if (!empty($_POST)) {
	...
	// 重複アカウントのチェック
	if (empty($error)) {
		$user = $db->prepare('SELECT COUNT(*) AS cnt FROM users WHERE mail=?');
...
<div id="wrap">
  ...
  <div id="content">
		...
		<dd>
			<input type="text" name="mail" size="35" maxlength="255" value="<?php echo htmlspecialchars($_POST['mail'], ENT_QUOTES, 'UTF-8'); ?>"/>
